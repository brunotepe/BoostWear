...
<html>
    ...
    <body>
        ...
        if (isset($_GET['go']) && $_GET['go'] != '') {
            ...
            if ($_REQUEST['senha'] != $_REQUEST['confirmar']) {
                ...
                $sql = "INSERT INTO cliente (idCliente,nome_cliente,telefone_cliente,senha_cliente,email_cliente,user_cliente) VALUES (" . $number . ",'" . $_REQUEST['nome'] .
                        "','".$telefone."','" . $_REQUEST['senha'] . "','" . $_REQUEST['email'] . "','" . $_REQUEST['user'] . "')";
                if (!$pdo->query($sql)) {
    ...
    <div class="container" style="position:absolute;left:32%;top:10%;border-style:outset;border-width:thin;border-radius:10px;border-radius:10px;background-color:#DCDCDC;width:500px;height:670px;">
        <form  action="cadastroCliente.php?go=1" method="POST" class="form-horizontal">
            <fieldset>
                <!-- Text input-->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="nome" name="nome" type="text" placeholder="Insira seu nome" class="form-control" required style="width:449px">
                        <p class="help-block">* Campo Obrigatório</p>
                    </div>
                </div>
